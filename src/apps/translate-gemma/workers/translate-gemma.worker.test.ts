...
describe("translate-gemma.worker", () => {
  ...
  it("should handle 'translate' message correctly in test environment", async () => {
    ...
    await import("./translate-gemma.worker");
    ...
    const promise = messageHandler({
      data: {
        type: "translate",
        data: { text: "Hello world", sourceLang: "en", targetLang: "es" },
      },
    } as MessageEvent);
