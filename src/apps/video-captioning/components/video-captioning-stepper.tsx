...
const steps = [
  { id: "step-1", step: 1, title: "Input Source", description: "Select a video" },
  { id: "step-2", step: 2, title: "Processing", description: "Downloading model & captioning" },
  ...
  return (
    <div className="bg-card mx-auto w-full max-w-4xl space-y-8 rounded-xl border p-6 shadow-sm">
      <div className="mb-4">
        ...
        <Muted>Generate and display captions from your video file.</Muted>
      </div>
