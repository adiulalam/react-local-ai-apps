...
const steps = [
  {
    ...
    description: "Upload, record, or pick sample voice",
  },
  {
    id: "step-2",
    step: 2,
    title: "Text & Parameters",
    description: "Set speech text and synthesis controls",
  },
  {
    id: "step-3",
    step: 3,
    title: "Generation",
    description: "Download model & clone voice speech",
  },
  {
    id: "step-4",
    step: 4,
    title: "Listen & Export",
    description: "Play and download cloned audio",
  },
];
  ...
  return (
    <div className="bg-card mx-auto w-full max-w-4xl space-y-8 rounded-xl border p-6 shadow-sm">
      <div className="mb-4">
        <H1>Voice Cloning</H1>
        <Muted>
          Zero-shot AI voice cloning and speech synthesis completely offline in your browser.
        </Muted>
      </div>
