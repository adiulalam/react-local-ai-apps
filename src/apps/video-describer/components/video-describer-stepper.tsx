...
import { DescriberStep } from "./steps/step-2";
...
const steps = [
  { id: "step-1", step: 1, title: "Input Source", description: "Select video or webcam" },
  {
    ...
    description: "Real-time AI visual narration",
  },
];

export const VideoDescriberStepper = () => {
  const { activeStep, prevStep, reset } = useVideoDescriberContext();

  return (
    <div className="bg-card mx-auto w-full max-w-4xl space-y-8 rounded-xl border p-6 shadow-sm">
      <div className="mb-4">
        <H1>AI Video Describer</H1>
        <Muted>Real-time visual scene narration and audio description powered by local AI.</Muted>
      </div>
              ...
              >
                ...
                <div className="flex gap-4">
                  ...
                  >
                    ...
                    {stepData.id === "step-2" && <DescriberStep />}
                  </StepperContent>
